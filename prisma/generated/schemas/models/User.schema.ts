...
export const UserSchema = z.object({
  ...
  fullName: z.string().meta({ examples: ["John Doe"], description: "Full name of the user" }),
  email: z.string().meta({ examples: ["john.doe@example.com"], description: "Email address of the user" }),
  imageUrl: z.string().meta({ examples: ["https://example.com/image.jpg"], description: "Profile image URL of the user" }).nullish(),
});
